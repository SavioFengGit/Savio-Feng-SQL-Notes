#group by, aggregate all rows by a specific column, often used with aggregate functions ex sum, max, min, avg and count
...
FROM transactions 
GROUP BY order_date; #mostra ordinato in base alla data
